...
namespace DiscoStation
{
    ...
    public class DataBase
    {
        ...
        /// <param name="values">conditions columns values</param>
        /// <returns>an array containing the columns values</returns>
        public List<KarmaLegoLib.TimeStampValueSymbol> loadTableTimestampsValues(string table, /*string column,*/ string[] columns, string[] values)
        {
            List<KarmaLegoLib.TimeStampValueSymbol> timeStampValueList = new List<KarmaLegoLib.TimeStampValueSymbol>();
            //SqlDataReader reader;
            //SqlCommand command = new SqlCommand();
            string str;
            int i;
            ...
            while (reader.Read())
            {
                KarmaLegoLib.TimeStampValueSymbol tivs = new KarmaLegoLib.TimeStampValueSymbol((int)reader["TimeStamp"], (double)reader["TemporalPropertyValue"]);
